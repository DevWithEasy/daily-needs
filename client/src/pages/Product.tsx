  ...
  return (
    <div>
      ...
      <Tabs>
        ...
        <TabPanels>
          <TabPanel>
            <div dangerouslySetInnerHTML={{__html : product?.description ? product?.description : ''}}></div>
          </TabPanel>
          <TabPanel>
          <div dangerouslySetInnerHTML={{__html : product?.additionalInfo ? product?.additionalInfo : ''}}></div>
          </TabPanel>
          <TabPanel>
            <h2>Got The Question About This Product?</h2>
            <div
              className="p-4 flex justify-between space-x-3 bg-gray-300"
            >
              <img 
